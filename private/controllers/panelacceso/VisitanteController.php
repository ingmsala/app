...
class VisitanteController extends Controller
{
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                                try{
                                    return in_array (Yii::$app->user->identity->role, [Globales::US_SUPER, Globales::US_SECRETARIA, Globales::US_CONSULTA, Globales::US_DIRECCION, Globales::US_INGRESO]);
                                }catch(\Exception $exception){
                                    return false;
                            }
                        }
    ...
    public function actionCron()
    {
        ...
        //foreach ($docentes as $docente) {
            //$array [$docente->documento] = $docente;
       // }
/*
        foreach ($nodocentes as $nodocente) {
            $array [$nodocente->documento] = $nodocente;
        }
*/
        ...
        foreach ($docentes as $persona) {
            ...
            $sendemail=Yii::$app->mailer->compose()
                            ...
                            ->setFrom([Globales::MAIL => 'Colegio Monserrat'])
                            ->setTo('msala@unc.edu.ar')
                            ->setSubject('Feliz cumple')
                            ->setHtmlBody('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]><html xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!--><html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
                            ...
                            * {
                            ...
                            </style><link href="https://fonts.googleapis.com/css?family=Raleway:400,700,400italic" rel="stylesheet" type="text/css" /><!--<![endif]--><style type="text/css">
                            ...
                            <!--<![endif]-->
                                ...
                                <div role="banner">
                                    ...
                                    <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                                        <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 149px;" src="https://admin.cnm.unc.edu.ar/front/assets/images/logo-encabezado.png" alt="" width="149" /></div>
                                    </div>
                                ...
                                <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #891f02;">
                                    <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background-color: #891f02;"><td style="width: 600px" class="w560"><![endif]-->
                                    ...
                                    <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top gnd-corner-image-bottom" style="border: 0;display: block;height: auto;width: 100%;max-width: 800px;" alt="" width="600" src="images/Top-Curve1-9900000000079e3c-9900000000079e3c.png" />
                                    </div>
                                ...
                                <div style="mso-line-height-rule: exactly;line-height: 40px;font-size: 1px;">&nbsp;</div>
                                    ...
                                    <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                    <img style="border: 0;display: block;height: auto;width: 100%;max-width: 480px;" alt="Happy Birthday!" width="480" src="https://admin.cnm.unc.edu.ar/front/assets/images/fc.jpg" />
                                    </div>
                                ...
                                <div class="layout one-col fixed-width stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #891f02;background: 100% 36%/auto auto no-repeat url(https://i1.createsend1.com/ei/t/94/593/4B2/225546/csfinal/Birthday-Template_13_13.png) #891f02;background-position: 100% 36%;background-image: url(https://i1.createsend1.com/ei/t/94/593/4B2/225546/csfinal/Birthday-Template_13_13.png);background-repeat: no-repeat;background-size: auto auto;">
                                    <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-fixed-width" style="background: 100% 36%/auto auto no-repeat url(https://i1.createsend1.com/ei/t/94/593/4B2/225546/csfinal/Birthday-Template_13_13.png) #891f02;background-position: 100% 36%;background-image: url(https://i1.createsend1.com/ei/t/94/593/4B2/225546/csfinal/Birthday-Template_13_13.png);background-repeat: no-repeat;background-size: auto auto;background-color: #891f02;"><td style="width: 600px" class="w560"><![endif]-->
                                    <div class="column" style="text-align: left;color: #565656;font-size: 17px;line-height: 26px;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                                ...
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;text-align: center;"><span style="color:#ffffff">Mensaje a personalizar: Feliz cumpleaños te deseamos de parte del Colegio Nacional de Monserrat</p>
                                    <p></p>
                                </div>
                                </div>
                                ...
                                <div role="contentinfo">
                                    ...
                                    <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
                                        <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #ffea96;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                                    ...
                                    <!--[if (mso)|(IE)]></td><td style="width: 200px;" valign="top" class="w160"><![endif]-->
                                        <div class="column narrow" style="text-align: left;font-size: 12px;line-height: 19px;color: #ffea96;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
                                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    ...
                                    <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-email-footer"><td style="width: 600px;" class="w560"><![endif]-->
                                        <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #ffea96;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
        ...
        //return $this->redirect(['index', 'arr' => $array]);
