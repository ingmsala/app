...
$this->title = 'Parte Docente - Control Secretaría Académica';
            ...
            [
                ...
                'buttons' => [
                    'savereg' => function($url, $model, $key){
                        ...
                        if ($model['estadoinasistenciax'] != 2){
                            return $model['id'] != '' ? Html::button('<span class="glyphicon glyphicon-edit"></span> Rectificar', ['value' => Url::to('index.php?r=estadoinasistenciaxparte/create&detalleparte='.$model['id'].'&estadoinasistencia=7'), 'class' => 'modalRegencia btn btn-danger btn-sm',  ]) : '';
                        }
                    },
