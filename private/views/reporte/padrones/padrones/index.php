                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-6">
                          ...
                          <a href="index.php?r=reporte/padrones/padrones/otrosdocentes&prop=1" class="btn btn-success btn-lg" role="button"><?= $cantidadotrosdocentes ?> <br/>Otros Docentes</a>
                        </div>
                        <div class="col-xs-6 col-md-6">
                          ...
                          <a href="index.php?r=reporte/padrones/padrones/otrosdocentes&prop=2" class="btn btn-success btn-lg" role="button"><?= $cantidadotrosdocentes ?> <br/>Otros Docentes</a>
                        </div>
                    </div>
