...
<body>
 ...
 (isset($_SESSION["dni"])) ? $uss = $_SESSION["dni"] : $uss="";
        NavBar::begin([
            'brandLabel' => '<img src="assets/images/logo-encabezado.png" style="display:inline; vertical-align: middle; height:35px;"><span id="brandspan-autogestion">Autogestión de Espacios Curriculares</span>',
            'brandUrl' => Url::to('index.php?r=curriculares%2Fautogestion%2Fagenda%2Findex'),
            'options' => [
                    ...
                    ['label' => '<span class="glyphicon glyphicon-user"></span><br>'.$uss.'',
                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'url' => ['/curriculares/autogestion/inicio'],
