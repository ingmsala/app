...
<?= $this->render('_filter', [
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'header' => '% de horas <br /> Inasistencias '.'<span data-toggle="tooltip" title="% de inasistencias respecto al total de la Optativa" class="glyphicon glyphicon-info-sign"></span>',
