...
<?php
   ...
   /*echo <div><b>Espacios Optativos</b></div> Html::dropDownList('comision', $selection=isset($_SESSION['comisionx']) ? $_SESSION['comisionx'] : 0, $listComisiones, ['prompt' => '(Seleccionar)', 'id' => 'cbmcomision', 'class' => 'form-control ',
        'onchange'=>'
...
$js2=<<< JS
     $ ( ' #comision-id ' ). on ( ' depdrop: change ' , function ( event , id , value, count ) {
      ...
      $.get( "index.php?r=optativas/default/setsession", { id: $(this).val() } )
                            .done(function( data ) {
