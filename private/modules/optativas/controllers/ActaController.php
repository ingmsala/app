                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            try{
                                if(in_array (Yii::$app->user->identity->role, [Globales::US_SUPER, Globales::US_SECRETARIA, Globales::US_CONSULTA, Globales::US_SACADEMICA, Globales::US_COORDINACION, Globales::US_PRECEPTORIA, Globales::US_REGENCIA]))
                                    return true;
