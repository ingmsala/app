...
class EspaciocurricularController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('/optativa/index', [
    ...
    public function actionView($id)
    {
        ...
        return $this->render('/optativa/view', [
    ...
    public function actionCreate()
    {
        ...
        return $this->render('/optativa/create', [
            'model' => $model,
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['/optativa/view', 'id' => $model->id]);
        }

        return $this->render('/optativa/update', [
            'model' => $model,
            'actividades' => $actividades,
            'aniolectivo' => $aniolectivo,
            'areasoptativas' => $areasoptativas,
    ...
    public function actionDelete($id)
    {
        ...
        return $this->redirect(['/optativa/index']);
    }
