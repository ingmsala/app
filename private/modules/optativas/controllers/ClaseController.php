                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            try{
                                return in_array (Yii::$app->user->identity->role, [1,3,6,8,9,12,13,14, Globales::US_PRECEPTORIA, Globales::US_REGENCIA]);
                    ...
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            try{
                                ...
                                if (in_array (Yii::$app->user->identity->role, [1,3,6,8,9,12,13,14, Globales::US_PRECEPTORIA, Globales::US_REGENCIA])){
