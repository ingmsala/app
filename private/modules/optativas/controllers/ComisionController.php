    ...
    public function actionComxanio()
    {
        ...
        if (isset($_POST['depdrop_parents'])) {
            ...
            if ($parents != null) {
                ...
                if(in_array (Yii::$app->user->identity->role, [Globales::US_SUPER, Globales::US_SACADEMICA, Globales::US_COORDINACION, Globales::US_SREI, Globales::US_CONSULTA, Globales::US_SECRETARIA, Globales::US_PRECEPTORIA])){
