...
class Myfunction {
	...
	public static function claseHoyView(){
        ...
        if(in_array (Yii::$app->user->identity->role, [8,9])){
            $clasesdehoy = Clase::find()
                ->joinWith(['comision0', 'comision0.docentexcomisions', 'comision0.docentexcomisions.docente0'])
                ->where(['fecha' => date('Y-m-d')])
                ->andWhere(['docente.legajo' => Yii::$app->user->identity->username])
