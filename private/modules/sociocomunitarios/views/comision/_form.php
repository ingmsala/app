...
<?php $listespaciocurricular=ArrayHelper::map($espaciocurricular,'id','actividad0.nombre'); ?>
...
<div class="comision-form">
    ...
    <?= 
        ...
        $form->field($model, 'espaciocurricular')->widget(Select2::classname(), [
            'data' => $listespaciocurricular,
