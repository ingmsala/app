...
<div class="comision-view">
    ...
    <?= Html::a('<span class="glyphicon glyphicon-plus"></span> Agregar Docente', ['/sociocomunitarios/docentexcomision/create', 'id' => $model->id], ['class' => 'btn btn-success']) ?>
                ...
                'buttons' => [
                    'view' => function($url, $model, $key){
                        return Html::a(
                            ...
                            '?r=sociocomunitarios/docentexcomision/view&id='.$model->id);
                    },
                    'update' => function($url, $model, $key){
                        return Html::a(
                            '<span class="glyphicon glyphicon-pencil"></span>',
                            '?r=sociocomunitarios/docentexcomision/update&id='.$model->id);


                    },
                    'delete' => function($url, $model, $key){
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', '?r=sociocomunitarios/docentexcomision/delete&id='.$model->id, 
                            ['data' => [
