...
<body>
    ...
    <div class="wrap">
        ...
        if(!Yii::$app->user->isGuest){
            ...
            }else if( in_array (Yii::$app->user->identity->role, [Globales::US_SECRETARIA, Globales::US_CONSULTA, Globales::US_DIRECCION, Globales::US_SACADEMICA, Globales::US_PSC, Globales::US_PRECEPTORIA, Globales::US_REGENCIA])){
                $items = [
