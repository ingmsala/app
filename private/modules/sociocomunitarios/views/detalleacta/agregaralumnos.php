...
/* @var $searchModel app\modules\espaciocurriculars\models\MatriculaSearch */
...
<h2>Agregar alumnos al acta de <?= $model->comision0->espaciocurricular0->actividad0->nombre.' ('.$model->nombre.')' ?></h2>
