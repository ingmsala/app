 ...
 */
class ListadoparasalidaController extends \yii\web\Controller
{
    /**
     * {@inheritdoc}
     */
                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            try{
                                return in_array (Yii::$app->user->identity->role, [1,3,6,12,14,20]);
    ...
    public function actionIndex()
    {
        ...
        $this->layout = 'main';
            ...
            $comision = isset($_SESSION['comisiontsx']) ? $_SESSION['comisiontsx'] : 0;
            if($comision != 0){
