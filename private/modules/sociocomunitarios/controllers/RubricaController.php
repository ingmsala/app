...
use app\modules\sociocomunitarios\models\RubricaSearch;
...
class RubricaController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $searchModelCalificacion = new CalificacionrubricaSearch();
        $dataProviderCalificacion = $searchModelCalificacion->porrubrica($id);

        return $this->render('view', [
            'model' => $this->findModel($id),
            'searchModelCalificacion' => $searchModelCalificacion,
            'dataProviderCalificacion' => $dataProviderCalificacion,
