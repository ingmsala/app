...
$listcatedras=ArrayHelper::map($catedras,'id',function($cat) use($aniolectivo){
    $doc = '';
...
$listhoras=ArrayHelper::map($horas,'id',function($model){
...
<div class="horario-form">
    ...
    <?= $form->field($model, 'catedra')->widget(Select2::classname(), [
     ...
     <?= $form->field($model, 'horareloj')->dropDownList($listhoras, 
        [
            'prompt' => 'Seleccionar...',
            'class' => 'form-control',
            'disabled' => 'disabled',
